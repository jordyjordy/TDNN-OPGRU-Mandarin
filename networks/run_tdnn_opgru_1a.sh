...
remove_egs=false
common_egs_dir=exp/chain/tdnn_opgru1a_sp/egs/
...
if [ $stage -le 12 ] && [ $stop_stage -gt 12 ] ; then
 ...
 opts="l2-regularize=0.00005"
  ...
  norm-opgru-layer name=opgru3 $opts cell-dim=$layer_dim recurrent-projection-dim=$linear_layer_dim non-recurrent-projection-dim=$linear_layer_dim delay=-3 dropout-per-frame=true dropout-proportion=0.0
