...
#     local/aidatatang_subset_data_prep.sh $data/corpus $data/transcript || exit 1;
# fi
...
#     utils/prepare_lang.sh --position-dependent-phones false data/local/dict "SPN" data/local/lang data/lang || exit 1;
